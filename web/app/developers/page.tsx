...
const topics = [["Getting started", "getting-started", "Build the project and understand repository boundaries."], ["Run a node", "node", "Node configuration, sync and operator concepts."], ["RPC / API", "rpc", "Public integration surface and safe endpoint boundaries."], ["Wallet integration", "wallets", "Wallet-oriented application concepts."], ["Payments", "payments", "Transaction integration principles."], ["Contributing", "contributing", "Issues, changes, tests and security reporting."], ["Protocol", "protocol", "Consensus and network architecture overview."]] as const;
