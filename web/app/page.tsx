    ...
    <>
      ...
      <section className="section-shell section-block">
        ...
        <div className="status-grid">
          ...
          <article><StatusChip status="Live" /><h3>Explorer + web integrations</h3><p>Public read-only explorer views, visitor counter, and faucet API are live on testnet through the reviewed public RPC proxy.</p><Link className="text-link" href="/explorer">Open explorer →</Link></article>
