...
export default function DownloadsPage() {
  return <div className="section-shell page-stack"><PageHero eyebrow="DOWNLOADS" title="Verified software, explicit status." description="The Android wallet downloads directly from this website. A GitHub account is not required. Download controls appear only where a public artifact and provenance are verified." />
    <section className="notice danger"><strong>Download safely.</strong><p>Use official links only. Verify checksums when published. Never enter a seed phrase or private key on a download page, support form or website prompt.</p></section>
