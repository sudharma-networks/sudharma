...
for file in \
  ...
  deployment/testnet/public-rpc/lambda/faucet-recovery.test.mjs \
  ...
  deployment/testnet/public-rpc/lambda/visitor-runtime.mjs \
  ...
  scripts/check-faucet-prepared-payout-recovery-contract_test.sh \
  scripts/check-faucet-recovery-retry-contract_test.sh; do
...
require_literal '/v1/website/visitors' deployment/testnet/public-rpc/lambda/router.mjs
require_literal '/v1/explorer/status' deployment/testnet/public-rpc/lambda/router.mjs
