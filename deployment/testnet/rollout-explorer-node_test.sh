...
require_literal 'RPC_BASE=http://127.0.0.1:28545'
require_literal '"$RPC_BASE/ready"'
require_literal '"$RPC_BASE/v1/status"'
require_literal '"$RPC_BASE/v1/explorer/status"'
