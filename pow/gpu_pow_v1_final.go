...
// gpuV1FinalizeDigest binds a canonical header digest to the reduced
...
//
// This primitive remains reference-only here. The canonical header+nonce path
// and chain verifier are reconciled in later isolated tasks without changing
// production activation constants.
